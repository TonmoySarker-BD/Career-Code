                ...
                <form onSubmit={handleSignIn} className="space-y-5">
                    <div>
                        ...
                        <input
                            ...
                            required
                            autoComplete="email"
                            className="mt-1 block w-full rounded-md px-3 py-2 text-base border border-gray-300 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary"
                        />
                    </div>
